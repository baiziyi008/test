<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sdk_manager.aspx.cs" Inherits="repack.sdk_manager" %>
...
<body style="margin:0px auto; width:986px;">
    <div style="width:100%; height:40px;">
        <div><input class="menu-button" type="button" value="新增SDK" onclick="document.location.href = 'upload_new_sdk.aspx';" /></div>
    </div>
    <div style="width:100%; margin-top:10px;">
        <table style="width:100%; font-size:13px; font-family:'微软雅黑'; color:#666666; border:1px solid #666666;" border="0" cellspacing="0" cellpadding="0">
            <tr style="background-color:#145eb0; color:#eeeeee; text-align:center;">
                ...
                <td style="width:100px;">SDK名称</td>
                <td style="width:120px;">说明</td>
                <td style="width:150px;">路径</td>
                <td style="width:150px;">处理类</td>
...
<script type="text/javascript">
    function on_delete(n) {
        ...
        form.append("type", "delete_sdk_form");
        form.append("id", n + "");
