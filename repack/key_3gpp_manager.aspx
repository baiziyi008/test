<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="key_3gpp_manager.aspx.cs" Inherits="repack.key_3gpp_manager" %>
...
<body style="margin:0px auto; width:986px;">
    <div style="width:100%; height:40px;">
        <div><input class="menu-button" type="button" value="添加3GPPKey" onclick="document.location.href = 'upload_new_3gpp.aspx';" /></div>
    </div>
    <div style="width:100%; margin-top:10px;">
        <table style="width:100%; font-size:13px; font-family:'微软雅黑'; color:#666666; border:1px solid #666666;" border="0" cellspacing="0" cellpadding="0">
            <tr style="background-color:#145eb0; color:#eeeeee; text-align:center;">
                ...
                <td style="width:100px;">渠道名</td>
                <td style="width:60px;">产品ID</td>
                <td style="width:60px;">渠道ID</td>
                <td style="width:150px;">AppKey</td>
...
<script type="text/javascript">
    function on_delete(n) {
        ...
        form.append("type", "delete_3gpp_form");
        form.append("id", n + "");
