<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="key_umeng_manager.aspx.cs" Inherits="repack.key_umeng_manager" %>
...
<body style="margin:0px auto; width:986px;">
    <div style="width:100%; height:40px;">
        <div><input class="menu-button" type="button" value="添加UmengKey" onclick="document.location.href = 'upload_new_umeng_key.aspx';" /></div>
    </div>
    <div style="width:100%; margin-top:10px;">
        <table style="width:100%; font-size:13px; font-family:'微软雅黑'; color:#666666; border:1px solid #666666;" border="0" cellspacing="0" cellpadding="0">
            <tr style="background-color:#145eb0; color:#eeeeee; text-align:center;">
                ...
                <td style="width:200px;">AppKey</td>
                <td style="width:250px;">MessageKey</td>
...
<script type="text/javascript">
    function on_delete(n) {
        ...
        form.append("type", "delete_umeng_key_form");
        form.append("id", n + "");
